...
package com.digitus.savr.glance.ui
...
import com.digitus.savr.data.successOr
import com.digitus.savr.model.Post
...
class SavrGlanceAppWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        val application = context.applicationContext as SavrApplication
