...
package app.digitus.savr.ui.theme
...
@Composable
fun SavrTheme(
    chosenTheme: String = "Follow system",
    ...
    val colorScheme =
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            if (makeDark) dynamicDarkColorScheme(context) else dynamicLightColorScheme(context)
        } else {
            if (makeDark) DarkColors else LightColors
        }
